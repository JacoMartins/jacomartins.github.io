...
function terminal(){
  ...
  var genwindoweventvalue = genwindowevent.value = `applicationfocus('generated${genid}-window')`;
    ...
    if(terminal.value.includes("msg")){
      ...
      setTimeout(() => {
        ...
        <div id="generated${genid}-window-header" class="window-header" onmouseover="">
          ...
          <button id="generated${genid}-window-close-button" class="window-header-close-button" onclick="closeapplication('generated${genid}-window')"></button>        
        ...
        <div id="generated${genid}-window-content" class="window-content">
          ...
          <button class="system-input-button" id="generated${genid}-window-content-input-button1" onclick="closeapplication('generated${genid}-window')">OK</button>
        </div>
