...
function settingsappchangepwform(){
        ...
        createDOMAttribute(genwindow, 'onmousedown', "applicationfocus('settings-changepw-subwindow', 1, 'settings-window')");
        ...
        <div id="settings-changepw-subwindow-header" class="window-header">
          ...
          <button id="settings-changepw-subwindow-close-button" class="window-header-close-button" onclick="closeWindow('settings-changepw-subwindow')"></button>        
...
function settingsappchangepw(){
  ...
  if(currentpwinput.value === localStorage.getItem('userpw') && confirmpwinput.value === pwinput.value && confirmpwinput.value.length > 5){
    ...
    closeWindow('settings-changepw-subwindow');
