...
function htmlviewerfocusWindow(app = document.getElementById('htmlviewer-window')){
...
function htmlviewerappopenwindow(){
  ...
  createDOMAttribute(genwindow, 'onmousedown', "applicationfocus('htmlviewer-window-open-window')");
  ...
  <div id="htmlviewer-window-open-window-header" class="window-header">
    ...
    <button id="htmlviewer-window-open-window-close-button" class="window-header-close-button" onclick="closeWindow('htmlviewer-window-open-window')"></button>        
...
closeWindow('htmlviewer-window-open-window');
}
}
