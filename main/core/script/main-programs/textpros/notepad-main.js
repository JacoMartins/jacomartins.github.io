...
function notepadfocusWindow(app = document.getElementById('notepad-window')){
...
function notepadappsavewindow(){
        ...
        createDOMAttribute(genwindow, 'onmousedown', "applicationfocus('notepad-window-save-window')");

        document.getElementById(`notepad-window-save-window`).innerHTML = `
        
        <div id="notepad-window-save-window-header" class="window-header">
        
          <button id="notepad-window-save-window-close-button" class="window-header-close-button" onclick="closeWindow('notepad-window-save-window')"></button>        
...
function notepadappsaveinput(){
  if(event.keyCode == 13){
    ...
    closeWindow('notepad-window-save-window');
  }
}
...
function notepadappopenwindow(){
  ...
  createDOMAttribute(genwindow, 'class', 'window');
  createDOMAttribute(genwindow, 'onmousedown', "applicationfocus('notepad-window-open-window')");

  document.getElementById(`notepad-window-open-window`).innerHTML = `
  
  <div id="notepad-window-open-window-header" class="window-header">
  
    <button id="notepad-window-open-window-close-button" class="window-header-close-button" onclick="closeWindow('notepad-window-open-window')"></button>        
...
closeWindow('notepad-window-open-window');
}
}
