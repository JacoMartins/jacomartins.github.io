...
function iframefocusWindow(app = document.getElementById('iframe-window')){
...
function iframeappopenwindow(){
  ...
  createDOMAttribute(genwindow, 'onmousedown', "applicationfocus('iframe-window-open-window')");

  document.getElementById(`iframe-window-open-window`).innerHTML = `
  
  <div id="iframe-window-open-window-header" class="window-header">
  
    <button id="iframe-window-open-window-close-button" class="window-header-close-button" onclick="closeWindow('iframe-window-open-window')"></button>        
...
closeWindow('iframe-window-open-window');
}
}
